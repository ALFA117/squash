  ...
  return (
    <main className="phone">
      <div className="screen-head">
        <PressLink href="/grupo" className="back" aria-label={t("Back to group", "Volver al grupo")}>
      ...
      {plan && (
        <>
          ...
          <section
            className="rise"
            style={{ animationDelay: "80ms", padding: "4px 22px 0" }}
          >
          ...
          <section
            className="rise"
            style={{ animationDelay: "160ms", padding: "4px 22px 0", display: "flex", flexDirection: "column", gap: 7 }}
          >
            ...
            <div className="card">
              {plan.transfers.map((t, index) => (
                <div
                  className="row rise"
                  key={`${t.from}-${t.to}`}
                  style={{ gap: 10, animationDelay: `${220 + index * 50}ms` }}
                >
          ...
          <div className="foot rise" style={{ gap: 10, border: "none", animationDelay: "300ms" }}>
            ...
            <span style={{ fontSize: 12.5, color: "var(--muted)", textAlign: "center" }}>
              {t(
                "Next, everyone who pays signs. It settles in dollars only when the last one does.",
                "Después firma cada quien que paga. Se liquida en dólares solo cuando firma el último.",
              )}
            </span>
            <PressLink className="btn btn-settle" href="/sign">
